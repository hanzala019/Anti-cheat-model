...
while True:
    try:
        ...
        if pose_results.pose_landmarks:
            ...
            cv2.putText(img, f"Left Distance: {int(left_shoulder_to_nose_distance)}", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
            cv2.putText(img, f"Right Distance: {int(right_shoulder_to_nose_distance)}", (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
            cv2.putText(img, f"Midpoint: {int(midpoint_shoulder_to_shoulder_distance)}", (10, 110), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (55, 255, 255), 2)
            cv2.putText(img, f"Left Angle: {int(left_angle)}", (10, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (155, 255, 255), 2)
            cv2.putText(img, f"Right Angle: {int(right_angle)}", (10, 170), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 2)
